...
def cleanning_report_format(df : object):
        ...
        df.to_csv(f'/media/sf_BLOB_STORAGE/Veolia_suez_Ton_Report/suez_csv/{current_date}_{location}.csv', index=False)
...
PATH = "/media/sf_BLOB_STORAGE/Veolia_suez_Ton_Report/og_suez_reports"
